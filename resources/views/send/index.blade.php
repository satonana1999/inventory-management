...
<main class="w-full flex flex-col flex-grow p-6">
	<form action="{{ route('send') }}" method="get">{{-- Memo デモ用にGETを設置 システム導入時POSTに変更 method="post" --}}
	...
	<div class="w-full mt-2">
		<h2 class="text-xl pb-3 flex items-center mt-5"><i class="fas fa-list mr-3"></i>発送一覧</h2>
			...
			<table class="border-2 border-gray-100 min-w-full bg-white">
				<thead class="bg-gray-800 text-white">
					<tr>
						...
						<th class="w-1/4 py-3 px-4 uppercase font-semibold text-left text-sm">取引先</th>
						<th class="w-1/6 py-3 px-4 uppercase font-semibold text-sm">受注数/在庫数</th>
						<th class="py-3 px-4 uppercase font-semibold text-sm">状態</th>
						<th class="py-3 px-4 uppercase font-semibold text-sm">金額</td>
						<th class="py-3 px-4 uppercase font-semibold text-sm">充当日</td>
				...
				<tbody class="text-gray-700">
					...
					<tr>
						<td class="border text-center py-3 px-4"><a tabindex="1" class="underline underline-offset-4 hover:text-blue-500" href="{{ route('send_entry') }}">2022/08/01</a></td>
						<td class="border text-left py-3 px-4">ヤマダ電機</td>
						<td class="border text-left py-3 px-4">10/9</td>
						<td class="border text-center py-3 px-4">未発送</td>
					...
					<tr class="bg-gray-200">
						<td class="border border border-gray-100 text-center py-3 px-4"><a tabindex="1" class="underline underline-offset-4 hover:text-blue-500" href="{{ route('send_entry') }}">2022/08/01</a></td>
						<td class="border border border-gray-100 text-left py-3 px-4">ヤマダ電機</td>
						<td class="border border border-gray-100 text-left py-3 px-4">10/9</td>
						<td class="border border border-gray-100 text-center py-3 px-4">発送済</td>
